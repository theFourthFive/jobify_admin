...
export default function getColumns (state, setState) {
  return [
    ...
    { field: "fullName", headerName: "Full name", width: 300, renderCell: showFullName },
    { field: "email", headerName: "E-mail", width: 280 },
    { field: "status", headerName: "Status", headerAlign: 'center', width: 130, renderCell: showStatus },
